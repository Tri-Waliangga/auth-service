-- Auth Service SNAP Security - MySQL baseline schema.
...
CREATE TABLE merchants (
  ...
  UNIQUE KEY uk_merchants_merchant_code (merchant_code),
...
CREATE TABLE api_clients (
  ...
  INDEX idx_api_clients_merchant_id (merchant_id),
...
CREATE TABLE client_public_keys (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_client_public_keys_client_key (api_client_id, key_id),
  INDEX idx_client_public_keys_api_client_id (api_client_id),
  INDEX idx_client_public_keys_validity (api_client_id, status, valid_from, valid_to),
...
CREATE TABLE client_scopes (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_client_scopes_client_scope (api_client_id, scope_code),
  INDEX idx_client_scopes_api_client_id (api_client_id),
  INDEX idx_client_scopes_service_code (service_code),
...
CREATE TABLE oauth_access_tokens (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_oauth_access_tokens_jti (token_jti),
  UNIQUE KEY uk_oauth_access_tokens_hash (token_hash),
  INDEX idx_oauth_access_tokens_api_client_id (api_client_id),
  INDEX idx_oauth_access_tokens_expires_at (expires_at),
  INDEX idx_oauth_access_tokens_client_exp (api_client_id, expires_at),
...
CREATE TABLE oauth_auth_codes (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  api_client_id BIGINT NOT NULL,
  auth_code_hash VARCHAR(128) NOT NULL,
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_oauth_auth_codes_hash (auth_code_hash),
  INDEX idx_oauth_auth_codes_api_client_id (api_client_id),
...
CREATE TABLE oauth_refresh_tokens (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_oauth_refresh_tokens_hash (refresh_token_hash),
  INDEX idx_oauth_refresh_tokens_api_client_id (api_client_id),
  INDEX idx_oauth_refresh_tokens_expires_at (expires_at),
  INDEX idx_oauth_refresh_tokens_client_exp (api_client_id, expires_at),
...
CREATE TABLE signature_audit_logs (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  INDEX idx_signature_audit_logs_request_id (request_id),
  INDEX idx_signature_audit_logs_api_client_id (api_client_id),
  INDEX idx_signature_audit_logs_created_at (created_at),
...
CREATE TABLE replay_protection_keys (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_replay_protection_keys_client_external_date_endpoint (api_client_id, external_id, request_date, endpoint_path),
  INDEX idx_replay_protection_keys_expires_at (expires_at),
...
CREATE TABLE api_audit_logs (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  INDEX idx_api_audit_logs_request_id (request_id),
  INDEX idx_api_audit_logs_api_client_id (api_client_id),
  INDEX idx_api_audit_logs_client_created_at (api_client_id, created_at),
  INDEX idx_api_audit_logs_response_code (response_code),
...
CREATE TABLE response_code_mappings (
  ...
  created_by VARCHAR(100) NOT NULL DEFAULT 'system',
  updated_by VARCHAR(100) NULL,
  UNIQUE KEY uk_response_code_mappings_response_code (response_code),
  INDEX idx_response_code_mappings_http_status (http_status),
  INDEX idx_response_code_mappings_service_case (service_code, case_code)
);
